...
OUTPUT_FILE=../../model/moeScore/moemucgec.out
HYP_PARA_FILE=../../model/moeScore/moemucgec.hyp.para
HYP_M2_FILE=../../model/moeScore/moemucgec.hyp.m2.char
REF_M2_FILE=../../model/mucgec.test.m2
SCORE_FILE=../../model/moeScore/mucgec_moe.score
# Step1. extract edits from hypothesis file.
echo "Step1. extract edits from hypothesis file."
paste $INPUT_FILE $OUTPUT_FILE | awk '{print NR"\t"$p}' > $HYP_PARA_FILE  # only for single hypothesis situation

echo "Extracting edits to m2 file..."
...
echo "Step2. compare hypothesis edits with reference edits."
