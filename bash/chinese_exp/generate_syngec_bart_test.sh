...
# 使用 fairseq-generate 进行高效批量推理
CUDA_VISIBLE_DEVICES=$CUDA_DEVICE python -u ${FAIRSEQ_DIR%_cli}/generate.py $MuCGEC_TEST_BIN_DIR \
    ...
    > $OUTPUT_DIR/mucgec.out.nbest # 直接将输出重定向到文件
