...
@register_model("syntax_moe_bart")
class SyntaxMoeBARTModel(SyntaxEnhancedMoeTransformerModel):
    @classmethod
    def hub_models(cls):
        return {
    ...
    @staticmethod
    def add_args(parser):
        super(SyntaxMoeBARTModel, SyntaxMoeBARTModel).add_args(parser)
        parser.add_argument(
            "--pooler-dropout",
            type=float,
            metavar="D",
...
@register_model_architecture("syntax_moe_bart", "syntax_moe_bart_large")
...
@register_model_architecture("syntax_moe_bart", "syntax_moe_bart_base")
